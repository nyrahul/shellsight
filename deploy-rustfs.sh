...
# S3 access credentials (for application read/write access)
...
services:
  ...
  # Init container to create bucket and app user
  rustfs-init:
...
echo
echo -e "${YELLOW}IMPORTANT: Save these credentials! They are also stored in .env.rustfs${NC}"
echo
echo -e "${GREEN}========================================${NC}"
